...
class PostviewsChartWidget extends StatelessWidget {
  const PostviewsChartWidget({super.key});
        ...
        child: Obx(() {
          ...
          return BarChart(
            BarChartData(
              ...
              barGroups: [
                BarChartGroupData(x: 0, barRods: [BarChartRodData(toY: posts, color: Colors.blue, width: 18)]),
                BarChartGroupData(x: 1, barRods: [BarChartRodData(toY: followers, color: Colors.green, width: 18)]),
                BarChartGroupData(x: 2, barRods: [BarChartRodData(toY: likes, color: Colors.orange, width: 18)]),
              ],
            ),
          );
        }),

...
class TrendingNgoList extends StatelessWidget {
  final controller = Get.find<ExploreScreenController>();

  TrendingNgoList({super.key});

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      // Use trending NGO list from /explore/ngos endpoint
      final all = controller.trendingNgoList;
            ...
            child: ListTile(
              ...
              trailing: Obx(() {
                ...
                return ElevatedButton(
                  ...
                  onPressed: () {
                    controller.toggleNgoFollow(id, index);
                  },

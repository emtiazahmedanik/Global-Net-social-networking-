...
class AllTrendingList extends StatelessWidget {
  final ExploreScreenController controller = Get.find<ExploreScreenController>();

  AllTrendingList({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final displayList = controller.searchQuery.value.isEmpty
          ? controller.trendingDataList
          : controller.filteredTrendingDataList;
            ...
            child: ListTile(
              ...
              trailing: Obx(() {
                ...
                return ElevatedButton(
                  ...
                  onPressed: () {
                    controller.toggleFollow(id, index);
                  },
